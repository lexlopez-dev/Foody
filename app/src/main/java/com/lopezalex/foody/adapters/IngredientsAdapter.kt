...
import com.lopezalex.foody.databinding.IngredientsRowLayoutBinding
import com.lopezalex.foody.models.ExtendedIngredient
import com.lopezalex.foody.util.Constants.Companion.BASE_IMAGE_URL
...
class IngredientsAdapter: RecyclerView.Adapter<IngredientsAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.binding.ingredientName.text = ingredientsList[position].name.uppercase()
